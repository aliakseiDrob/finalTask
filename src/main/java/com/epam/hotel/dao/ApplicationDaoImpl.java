...
public class ApplicationDaoImpl extends AbstractPersistentDao<Application> implements ApplicationDao {
    ...
    @Override
    public int differenceBetweenDate(Long id) throws DaoException {
    ...
    @Override
    public List<Application> findPaginatePageInProgress(int items, int begin) throws DaoException {
        return executeQuery(SELECT_PAGE_IN_PROGRESS, items, begin);
    }

    @Override
    public Long findRowCountInProgress() throws DaoException {
    ...
    @Override
    public List<Application> findPaginatePageByUserId(long id, int items, int begin) throws DaoException {
