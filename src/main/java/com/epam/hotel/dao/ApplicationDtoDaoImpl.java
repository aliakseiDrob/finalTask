...
public class ApplicationDtoDaoImpl extends AbstractDao<ApplicationDto> implements ApplicationDtoDao {
    ...
    private static final String SELECT_PAGE_BY_CONDITION = "SELECT room.number, application.check_in,application.check_out,room.type,room.capacity, application.invoice " +
    ...
    private static final String GET_PAGE_BY_USER_ID = "SELECT room.number, application.check_in,application.check_out,room.type,application.capacity, application.invoice " +
    ...
    @Override
    public List<ApplicationDto> findLimitByUserId(long id, int items, int begin) throws DaoException {
