...
insert into application (check_in,check_out,room_type,capacity,status,user_id,room_id,invoice) values ('2021-02-15','2021-02-18','STANDARD',2,'IN_PROGRESS',2,0,0);
...
insert into application (check_in,check_out,room_type,capacity,status,user_id,room_id,invoice) values ('2021-02-24','2021-02-26','COMFORT',1,'IN_PROGRESS',2,0,0);
insert into application (check_in,check_out,room_type,capacity,status,user_id,room_id,invoice) values ('2021-02-27','2021-02-28','PRESIDENT',1,'IN_PROGRESS',2,0,0);
insert into application (check_in,check_out,room_type,capacity,status,user_id,room_id,invoice) values ('2021-02-20','2021-02-21','STANDARD',2,'IN_PROGRESS',3,0,0);
insert into application (check_in,check_out,room_type,capacity,status,user_id,room_id,invoice) values ('2021-02-24','2021-02-26','COMFORT',1,'IN_PROGRESS',3,0,0);
insert into application (check_in,check_out,room_type,capacity,status,user_id,room_id,invoice) values ('2021-02-27','2021-02-28','PRESIDENT',1,'IN_PROGRESS',3,0,0);
insert into application (check_in,check_out,room_type,capacity,status,user_id,room_id,invoice) values ('2021-03-20','2021-03-21','STANDARD',2,'IN_PROGRESS',2,0,0);
insert into application (check_in,check_out,room_type,capacity,status,user_id,room_id,invoice) values ('2021-02-21','2021-02-26','COMFORT',1,'IN_PROGRESS',2,0,0);
insert into application (check_in,check_out,room_type,capacity,status,user_id,room_id,invoice) values ('2021-02-01','2021-02-01','PRESIDENT',1,'IN_PROGRESS',2,0,0);
