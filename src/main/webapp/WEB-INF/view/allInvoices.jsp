...
<head>
    <title>
       <fmt:message key="label.left_pane.admin.all_invoices"/>
    </title>
    ...
    <div class="main">
        <table>
            <c:if test="${sessionScope.userRole eq 'ADMINISTRATOR'}">
             <caption>   <fmt:message key="label.left_pane.admin.all_invoices"/></caption>
            </c:if>
            <c:if test="${sessionScope.userRole eq 'GUEST'}">
            <caption>   <fmt:message key="label.left_pane.guest.all_invoices"/> </caption>
            </c:if>
            <tr>
                <th>№</th>
                <th><fmt:message key="label.all_invoices.room_number"/></th>
                <th><fmt:message key="label.all_invoices.check_in"/></th>
                <th><fmt:message key="label.all_invoices.check_out"/></th>
                <th><fmt:message key="label.all_invoices.room_type"/></th>
                <th><fmt:message key="label.all_invoices.guests"/></th>
                <th><fmt:message key="label.all_invoices.price"/></th>
            </tr>
            <c:forEach var="elem" items="${requestScope.allInvoices}" varStatus="status">
                <tr>
